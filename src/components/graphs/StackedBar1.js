...
class StackedBar1 extends Component {
        ...
        return (
            <>
                ...
                <div className="bgWhite">
                    <Bar id="myChart" data={this.props.graphData} height={500} options={{
...
export default withRouter(StackedBar1)