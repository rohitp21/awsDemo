...
export default class BlockStorageBlockVolume extends Component {
                ...
                <Row>
                                ...
                                this.state.data.map((item, i) =>
                                    ...
                                    <NavItem key={i}>
                                        ...
                                        <Nav vertical className="bgWhite ml-2">
                                            {
                                                item[1] && Object.entries(item[1].blockvolumes).map((blockvolume, j) =>
                                                    <NavItem key={blockvolume[0] + '_' + i + '_' + j}>
                                                        <NavLink className={'innerA ' +
                                                            (this.state.displaybleData && this.state.displaybleData.includes(blockvolume[0]) ? "d-block" : "d-none")
                                                        }
                                                            onClick={() => {
                                                                this.toggle(blockvolume[0] + '_' + i + '_' + j);
                                                            }}>{blockvolume[1].name ? blockvolume[1].name : blockvolume[1].fetch_id}
                                                        </NavLink>
                                                    </NavItem>
                                                )
                    ...
                    <Col xs="9" sm="9" md="9">
                        ...
                        {this.state.data &&
                            this.state.data.map((item, i) =>
                                item[1] && Object.entries(item[1].blockvolumes).map((blockvolume, j) =>
                                    <div key={blockvolume[0] + '_' + i + '_' + j}
                                        className={
                                            (item[0] + '_' + i) + " " +
                                            (blockvolume[0] + '_' + i + '_' + j) +
                                            " detailCard poseRelative " +
                                            (this.state.displaybleData && this.state.displaybleData.includes(blockvolume[0].replace(/\(.*?\)/g, '.')) ? "d-block" : "d-none")
                                        }
                                    >
                                        ...
                                        <Accordion>
                                            ...
                                            >
                                                <h5>{blockvolume[1].name ? blockvolume[1].name : blockvolume[1].fetch_id}</h5>
                                            </AccordionSummary>
                                            <AccordionDetails>
                                                <div className="px-2 py-1">
                                                    ...
                                                    <div className="p-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <CardSubtitle className="pb-2"><span className="font-weight-500">ID: </span><span>{blockvolume[1].fetch_id}</span></CardSubtitle>
                                                            <CardSubtitle className="pb-2"><span className="font-weight-500">Created On:</span> <span>{blockvolume[1].time_created}</span></CardSubtitle>
                                                            <CardSubtitle className="pb-2"><span className="font-weight-500">Availability Domain:</span> <span>{blockvolume[1].availability_domain}</span></CardSubtitle>
                                                            <CardSubtitle className="pb-2"><span className="font-weight-500">KMS Key:</span> <span>{blockvolume[1].kms_key_id != null ? "True" : "False"}</span></CardSubtitle>
                                                            <CardSubtitle className="pb-2"><span className="font-weight-500">Size In Gbs:</span> <span>{blockvolume[1].size_in_gbs}</span></CardSubtitle>
                                                    ...
                                                    <div className="p-3">
                                                        <h4 className="pb-2 font-weight-500">Defined Tags ({Object.entries(blockvolume[1].defined_tags).length})</h4>
                                                        {
                                                            Object.entries(blockvolume[1].defined_tags).length > 0 && Object.entries(blockvolume[1].defined_tags).map((tags, s) =>
                                                                <div>
                                                    ...
                                                    <div className="p-3">
                                                        <h4 className="pb-2 font-weight-500">Freeform Tags ({Object.entries(blockvolume[1].freeform_tags).length})</h4>
                                                        {
                                                            Object.entries(blockvolume[1].freeform_tags).length > 0 && Object.entries(blockvolume[1].freeform_tags).map((tags, s) =>
                                                                <div>
