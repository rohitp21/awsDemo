...
export default class IdentityPolicies extends Component {
                        ...
                        <Nav vertical className="browserHeight1  bgWhite">
                            <NavItem>
                                <NavLink
                                    ...
                                    onClick={() => {
                                        this.showAll()
                                    }}> Show All({this.state.data && this.state.data.length})</NavLink>
                            </NavItem>
                            {this.state.data ?
                                        ...
                                        <AccordionDetails>
                                            <div className="px-2 py-1">
                                                ...
                                                <div className="p-3">
                                                    ...
                                                    <CardText className="mb-0">Description: {item[1].description}</CardText>
                                                    <CardText className="mb-0">State: {item[1].state}</CardText>
                                                </div><hr />
                                                <div className="p-3">
                                                    <CardSubtitle className="font-weight-500">Statements</CardSubtitle>
                                                    {item[1].statements.length !== 0 ?
                                                        item[1].statements.map((item2, j) =>
                                                            <CardText key={j}>- {item2}</CardText>
                                                        )
                                                        :
                                                        null
                                                    }
