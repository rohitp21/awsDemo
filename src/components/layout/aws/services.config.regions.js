...
export default class ConfigRegions extends Component {
                                    ...
                                    <Accordion>
                                        <AccordionSummary
                                            ...
                                            <AccordionDetails>
                                                    <div className="mb-3">
                                                        <h5>Information</h5>
                                                       <p> {this.state.displaybleData && this.state.displaybleData.includes(item[0]) && this.state.id_suffix ? <span> Configured: &nbsp; <span className="id_suffix1">{this.state.id_suffix}</span></span> : null}</p>
                                                    </div>
                                                    <Divider/>
                                                    <div className='mt-3'>
                                                        <h5 className="pb-2 font-weight-500">Recorders({Object.keys(item[1].recorders).length})</h5>
                                                        {
                                                            Object.keys(item[1].recorders).length > 0 && Object.keys(item[1].recorders).map((item, i) =>
                                                    ...
                                                    <div className="mt-3">
                                                        <h5>Rules({Object.keys(item[1].rules).length})</h5>
                                                        {
                                                            Object.keys(item[1].rules).length > 0 && Object.keys(item[1].rules).map((item, i) =>
