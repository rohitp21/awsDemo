...
import { Breadcrumb, BreadcrumbItem, Nav, NavItem, NavLink, CardSubtitle, CardText, Row, Col } from 'reactstrap';
...
export default class IamGroups extends Component {
                                    ...
                                    <Accordion>
                                        <AccordionSummary
                                            ...
                                            <AccordionDetails>
                                                    ...
                                                    <div className="p-3">
                                                        <CardSubtitle className="pb-2 font-weight-500"><h4>Information</h4></CardSubtitle>
                                                        <CardText className="mb-0">Creation date: {item[1].CreateDate}</CardText>
                                                    </div>
                                                    <Divider/>
                                                    <div className="p-3">
                                                        <CardSubtitle className="font-weight-500"><h4>Members({item[1].users.length})</h4></CardSubtitle>
                                                        <div>
                                                            {

                                                                item[1].users.map((item, i) =>
                                                                    <>
                                                                        <div>{item}</div>
                                                                    </>
                                                                )
                                                    ...
                                                    <div className="p-3">
                                                        <h5 className="pb-2 font-weight-500">Inline Policies({item[1].inline_policies_count})</h5>
                                                        {
                                                    ...
                                                    <div className="p-3">
                                                        <h5 className="pb-2 font-weight-500">Managed Policies({item[1].policies_counts})</h5>
                                                        {
