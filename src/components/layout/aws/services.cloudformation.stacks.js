...
export default class CloudFormationStacks extends Component {
        ...
        return (
            ...
            <div>
                <Row>
                                ...
                                this.state.data.map((item, i) =>
                                    <NavItem key={i}>
                                        ...
                                        <Nav vertical className="bgWhite ml-2">
                                            {
                                                Object.entries(item[1].stacks).map((stacks, j) =>
                                                    <NavItem key={j}>
                                                        <NavLink className={'innerA ' +
                                                            (this.state.displaybleData && this.state.displaybleData.includes(stacks[0]) ? "d-block" : "d-none")
                                                            // (this.state.showThis === item[1].name ? "active " : null)
                                                        }
                                                            onClick={() => {
                                                                this.toggle(stacks[0] + '_' + i + '_' + j);
                                                            }}>
                                                            {stacks[1].name}
                    ...
                    <Col xs="9" sm="9" md="9">
                        {/* select view  starts */}
                        <div className="dashboard-container full_max_width">
                            <div className="row ">
                                            ...
                                            >
                                                  <Accordion>
                                                    ...
                                                    <AccordionDetails>
                                                            ...
                                                            <Divider/>
                                                                <h5>Description</h5>
                                                                <div>{stacks[1].Description ? stacks[1].Description : "-"}</div>
                                                            </div>
                                                            ...
                                                            <div className='mt-3 mb-3'>
                                                                ...
                                                                <ListGroup>
                                                                    ...
                                                                    <ListGroupItem className="pb-2 font-weight-500">Created on: {stacks[1].CreationTime}</ListGroupItem>
                                                                    <ListGroupItem className="pb-2 font-weight-500">Role: {stacks[1].iam_role ? stacks[1].iam_role.name : "No Role"}
                                                                    </ListGroupItem>
                                                                    <ListGroupItem className="pb-2 font-weight-500">Termination protection enabled: {stacks[1].termination_protection ? "True" : "False"}</ListGroupItem>
                                                                    <ListGroupItem className="pb-2 font-weight-500">Configuration has drifted: {stacks[1].drifted ? "True" : "False"}</ListGroupItem>
                                                                    <ListGroupItem className="pb-2 font-weight-500">Deletion policy: {stacks[1].deletion_policy ? "True" : "False"}</ListGroupItem>
                                                                </ListGroup>
                                                            </div>
                                                            <Divider/>
                                                            <div className="mt-3">
                                                                <h5>Capabilities({stacks[1].Capabilities ? stacks[1].Capabilities.length : "0"})</h5>
                                                                <div>
                                                                    {
                                                                        stacks[1].Capabilities && stacks[1].Capabilities.map((item, i) =>
                                                                            <span> {item}<br /></span>
                                                                        )
                                                                    }
