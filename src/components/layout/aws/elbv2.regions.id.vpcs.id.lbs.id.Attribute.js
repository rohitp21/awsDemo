...
export default class Elbv2Attribute extends Component {
    constructor(props) {
        super(props);
                                                        ...
                                                        <Nav vertical className="bgWhite  ml-4">
                                                            {
                                                                v[1] && Object.entries(v[1].lbs).map((lbs, k) =>
                                                                    <NavItem key={k} className={"hhh"
                                                                        ...
                                                                        <Nav vertical className="bgWhite  ml-4">
                                                                            {
                                                                                lbs[1] && Object.entries(lbs[1].attributes).map((attribute, l) =>
                                                                                    <NavItem key={l} className={
                                                                                        (this.state.displayableData &&
                                                                                            ...
                                                                                            this.state.displayableData4.includes(attribute[0])
                                                                                            ? "d-block" : "d-none")
                                                                                    }>
                                                                                        <NavLink onClick={() => {
                            ...
                            <div className="row p-0">
                                <div className="col-md-12">
                                    <Breadcrumb tag="nav" listTag="div">
                                        ...
                                        <BreadcrumbItem className="text-capitalize" tag="a">{this.props.dbName}</BreadcrumbItem>
                                            ...
                                            lbs[1] && Object.entries(lbs[1].attributes).map((attribute, l) =>
                                                ...
                                                >
                                                    ...
                                                    <AccordionSummary
                                                        ...
                                                        >
                                                        <h5>{item[0]}/{lbs[1].name}/{attribute[0]}</h5>
                                                        </AccordionSummary>
                                                         <AccordionDetails>
                                                                <div className="px-2 py-1 d-flex">
                                                                    {
                                                                        attribute[1] && Object.entries(attribute[1]).map(([k, v]) =>
                                                                            <div>
                                                                                {k &&
                                                                                    typeof (v) != 'object' &&
