...
export default class IamPolicies extends Component {
                                ...
                                >
                                    ...
                                    <AccordionSummary
                                            ...
                                            <AccordionDetails>
                                                    ...
                                                    <div className="p-3">
                                                        <h5 className="pb-2 font-weight-500 blackColor-1 d-inline fs14">{item[1].arn}</h5><br/>
                                                        <code className="mb-0">{
                                                            Object.entries(JSON.stringify(item[1].PolicyDocument)).map(([, val]) =>
                                                                <>
                                                                    {val === '{' || val === '}' || val === '[' || val === ']' || val === ',' ?
                                                                        <span>{val}<br /></span>
                                                                        :
                                                    ...
                                                    <div className="pt-3">
                                                        <h5>Attached Entities</h5>
                                                        {
                                                            item[1].attached_to.roles && item[1].attached_to.roles.map((item, i) =>
                                                                <div>
                                                                    {item.name}
                                                                </div>
                                                            )
