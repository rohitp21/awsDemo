...
export default class CloudTrailRegions extends Component {
                                ...
                                >
                                    ...
                                    <Accordion>
                                        <AccordionSummary
                                            ...
                                            id={"panel" + i + "d" + "-header"}
                                            >
                                                <h5 className="border_bottom_header p-3 font-weight-500">{item[1].name}</h5>
                                            </AccordionSummary>
                                            <AccordionDetails>
                                            <Divider/>
                                            <ListGroup key={i}>
                                                ...
                                                <ListGroupItem className="pb-2 font-weight-500"><span>Id</span>: <span>{item[1].id}</span></ListGroupItem>
                                                <ListGroupItem className="pb-2 font-weight-500"><span>Region</span>: <span>{item[1].region}</span></ListGroupItem>
                                                <ListGroupItem className="pb-2 font-weight-500"><span>Trails Count</span>: <span>{item[1].trails_count}</span></ListGroupItem>
                                            </ListGroup>
                                            </AccordionDetails>
                                        </Accordion>
